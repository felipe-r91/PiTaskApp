      ...
      <section className="w-full">
        <div className="bg-off-white flex flex-col h-screen">
          <div className="w-full h-fit flex items-center">
            ...
            <Link type='button' title="broadcast" className="h-8 w-10 rounded-full bg-purple-light py-1 px-2 shadow-custom absolute right-12 top-24 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110" to={"/Broadcast"}>
